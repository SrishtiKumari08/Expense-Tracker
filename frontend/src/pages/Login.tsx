...
export const Login: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center p-4 bg-app-bg text-app-text md:flex-row md:p-0">
      ...
      <div className="glow-bg top-[-10%] left-[-10%] opacity-60" />
      ...
      <div className="relative flex w-full max-w-5xl overflow-hidden rounded-2xl border border-app-border bg-app-card shadow-2xl md:grid md:grid-cols-12 md:rounded-3xl">
        ...
        <div className="relative hidden flex-col justify-between bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-900 p-12 text-white md:col-span-5 md:flex">
          ...
          <div className="z-10 space-y-6">
            ...
            <p className="text-sm text-indigo-200/70 leading-relaxed">
              Log in to access your custom dashboards, review transaction archives, and manage budgets in real time.
            </p>
            ...
            <div className="space-y-3 pt-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-indigo-200/90 font-medium">Real-time expense visualizations</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-indigo-500/20 p-1">
                  <ShieldCheck className="h-4 w-4 text-indigo-300" />
                </div>
                <span className="text-xs text-indigo-200/90 font-medium">Bank-grade JWT session protection</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center px-6 py-12 sm:px-12 md:col-span-7 lg:px-16">
          <div className="mx-auto w-full max-w-md space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 transition-all hover:opacity-95 active:scale-[0.99] disabled:opacity-50 disabled:pointer-events-none"
              >
                {isLoading ? (
